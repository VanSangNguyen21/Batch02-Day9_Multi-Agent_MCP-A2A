...
def check_routing(state: State) -> list[Send]:
    ...
    # Thêm logic routing cho privacy_agent
...
def privacy_agent(state: State) -> dict:
    ...
    llm = get_llm()
    prompt = f"""Bạn là chuyên gia về bảo vệ dữ liệu cá nhân và GDPR. Phân tích khía cạnh bảo mật dữ liệu trong câu hỏi:
    
Câu hỏi: {state['question']}
Phân tích pháp lý: {state.get('law_analysis', 'N/A')}

Tập trung: GDPR, data protection, privacy rights, data breach, hậu quả pháp lý liên quan đến rò rỉ dữ liệu."""
